  ...
  if(isset($_POST['update_sale'])){
    ...
    validate_fields($req_fields);
        if(empty($errors)){
        	...
        	/* === added by Yoel, at 2019.03.12 === */
        	/*$sql1  = "SELECT * FROM products";
          $sql1 .= " WHERE id ='{$product['id']}'";
          $result = $db->find_by_sql($sql1);
          if( $result ){
          ...
          <th> Action</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <input type="text" class="form-control" name="From" value="<?php echo remove_junk($product['buy_price']); ?>">
                </td>
                <td id="s_date">
